...
namespace PlanBee
{
    public class Ghc_ExitAccessBetween : GH_TaskCapableComponent<Ghc_ExitAccessBetween.SolveResults>
    {
        ...
        {
            OUT_pathMetric = pManager.AddNumberParameter("Normalized frequency cell used", "Normalized frequency", "The exit path frequency of each cell, remapped from 0 to 1 using the bounds of the plan as remapping domain", GH_ParamAccess.list);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.ExitPaths_Frequency_01;
            }
        }
